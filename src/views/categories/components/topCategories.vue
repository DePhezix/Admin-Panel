...
const dialogComponents: Partial<Record<navigationType, ReturnType<typeof defineAsyncComponent>>> = {
  Organization: defineAsyncComponent(
    () => import("@/views/organizations/components/createOrganization.vue"),
  ),
  Staff: defineAsyncComponent(
    () => import("@/views/staffAndActivities/components/createStaff.vue"),
  ),
  Activity: defineAsyncComponent(
    () => import("@/views/staffAndActivities/components/createActivity.vue"),
  ),
  "Staff Activity": defineAsyncComponent(
    () => import("@/views/staffActivities/components/createStaffActivity.vue"),
  ),
};
