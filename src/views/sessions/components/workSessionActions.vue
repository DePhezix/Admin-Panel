...
const form = reactive<editSessionFormType>({
...
const handleEditConfirm = async () => {
  if (props.workerSessionId && form.activityId) {
    try {
...
watch(editOpen, async () => {
  if (editOpen.value) {
    console.log("ORG: " + props.org_id);
    staffActivityStore.fetchStaffActivity(props.org_id, props.workerName);
    staffStore.fetchStaff(props.org_id);
  }
});
</script>
